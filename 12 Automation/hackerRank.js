...
browerLaunch.then(function(browserInstance){
    ...
    let emailEnterPromise = page.type("input[id='input-1']", email, {delay : 100})
    return emailEnterPromise
}).then(function(){
    let passEnterPromise =  page.type("input[id='input-2']", password, {delay:100})
